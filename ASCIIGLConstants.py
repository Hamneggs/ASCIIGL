...
"""
	Enable or disable shader capability.
"""
DISABLE_SHADING 	= 1
ENABLE_CHAR 		= 2
ENABLE_TEX 			= 4
ENABLE_CHAR_AND_TEX = 8
shaderUsage = DISABLE_SHADING
...
"""
	The color editing mode. This defines what ANSI character
	attributes to pile into the framebuffer per frame. More
	attributes makes the framebuffer a longer string, so
	frametimes lengthen with more attributes.
"""
EDIT_COLOR 				= 1
...
"""
	When and how often the renderer checks the console window dimensions against
	the framebuffer size. 
"""
SIZE_CHECK_AT_INTERVAL  = 1
SIZE_CHECK_AT_START		= 2
windowSizeCheck			= SIZE_CHECK_AT_START

"""
	How many frames should there be between size checks?
"""
